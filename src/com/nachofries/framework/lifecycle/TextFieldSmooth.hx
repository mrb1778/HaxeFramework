...
#end
{
	...
	var textFieldBold:Bool;
	var textFieldFormat:TextFormat;
	var textFieldSize:Float;
	...
	public function new (stringText:String="",font:Font,?size:Float=20.0,?color:Int=0x000000,?bold=false, ?smoothing:Bool=true) {
	    ...
	    var textFieldFormat:TextFormat = new TextFormat(textFieldFont.fontName, textFieldSize , textFieldColor, textFieldBold);
