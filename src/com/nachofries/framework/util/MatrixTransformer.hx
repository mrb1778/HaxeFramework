...
class MatrixTransformer {
    ...
    public static function getSkewXRadians(m:Matrix):Float {
    ...
    public static function getSkewYRadians(m:Matrix):Float {
    ...
    public static function getSkewX(m:Matrix):Float {
    ...
    public static function getSkewY(m:Matrix):Float {
    ...
    public static function getRotationRadians(m:Matrix):Float {
    ...
    public static function getRotation(m:Matrix):Float {
